    ...
    public class Log
    {
      ...
      //  private static readonly ILog _logModify = LogManager.GetLogger("JMModifyLogger");
       ...
       // private static readonly ILog _logException = LogManager.GetLogger("JMModifyLogger");
        ...
        /// 日志清理线程变量
        /// </summary>
        private static Thread _cleanThread = null;

        /// <summary>
        /// 日志保留天数字段和属性
        /// </summary>
        private static volatile int _logRemainDays = 10;

        public static int LogRemainDays
        {
      ...
      //  private static RichTextBoxBaseAppender list_logAppender = new RichTextBoxBaseAppender();
        ...
        public static void RegisterLog(string LogName="")
        {
            IsStarting = true;
            ...
            if (LogName.Length>0)
            {
                _log4Net = LogManager.GetLogger(LogName);
            }
            else
            {
        ...
        public static void UpdateDispMinRade(string strRade)
        {
